app.controller('AuthController', ['$rootScope','$scope','$http','$location','$window','$localStorage','Auth','User','toastr', function($rootScope,$scope,$http,$location,$window,$localStorage,$sessionStorage,Auth,User,toastr) {
